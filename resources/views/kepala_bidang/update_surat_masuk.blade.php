...
<div class="flex gap-5 mb-3">
    ...
    <p class="ml-auto my-auto font-bold">Terakhir diperbarui: {{$suratMasuk -> updated_at}}</p>
</div>
<form action="/KepalaBidang/EditArsipSuratMasukSubmit-{{ $suratMasuk -> id }}" method="Post">
    @csrf
    @method('put')
    ...
    <div class="my-2">
        ...
        <input name="berkas" class="block w-[50%] text-sm text-gray-500 border border-[#006B3F] rounded cursor-pointer bg-white focus:outline-none" type="file" required>Nama Berkas Sebelumnya: {{ $suratMasuk -> berkas }}
    </div>
    <div class="mt-[30px]">
